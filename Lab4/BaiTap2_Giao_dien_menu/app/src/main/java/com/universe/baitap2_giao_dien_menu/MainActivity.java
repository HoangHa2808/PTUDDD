package com.universe.baitap2_giao_dien_menu;
...
public class MainActivity extends AppCompatActivity {
    private static final int[] ID_DRAWABLES = {R.drawable.chat, R.drawable.airplane, R.drawable.hospital,
            R.drawable.home, R.drawable.restaurant, R.drawable.shaker, R.drawable.shopping,
            R.drawable.suitcase, R.drawable.clock, R.drawable.education, R.drawable.movie};

    private static final int[] ID_TEXTS = {R.string.txt_mess, R.string.txt_flight, R.string.txt_hospital,
            R.string.txt_hotel, R.string.txt_restaurant, R.string.txt_coctail, R.string.txt_store,
            R.string.txt_work, R.string.txt_time, R.string.txt_education, R.string.txt_movie};
